...
// // A simple loading skeleton component to improve UX
...
// const DashboardPage: React.FC = () => {
//   // The useAuth hook provides user data and a loading state
//   const { user, loading } = useAuth();

//   // --- Safe Data Access ---
//   // Use optional chaining (?.) and provide a fallback ('') to prevent the error.
//   // This ensures that even if user or fullName is null/undefined, the code won't crash.
...
//                   <div className="h-8 bg-green-900 rounded w-3/4 mb-2"></div>
//                   <div className="h-5 bg-green-900 rounded w-1/2"></div>
//                 </div>
//               ) : (
//                 <>
//                   <h1 className="text-2xl font-bold mb-2">
...
//             {/* The rest of your dashboard content can follow a similar loading pattern */}
//             {/* ... */}
